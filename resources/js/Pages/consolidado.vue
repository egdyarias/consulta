    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
      <Link :href="route('consultas.index')">
        <DarkButton class="mr-4 flex justify-center items-center gap-2">
          ...
          <div>Consultas por día</div>
        </DarkButton>
      </Link>
      <Link :href="route('movimientoBS.index')">
        <DarkButton class="mt-4 mr-4 flex justify-center items-center gap-2">
          ...
          <div>Gestionar Movimientos BS</div>
        </DarkButton>
      </Link>
      <Link :href="route('movimientoUSD.index')">
        <DarkButton class="mt-4 mr-4 flex justify-center items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
            <path
          ...
          <div>Gestionar Movimientos USD</div>
        </DarkButton>
      </Link>
    </div>
  </AuthenticatedLayout>
